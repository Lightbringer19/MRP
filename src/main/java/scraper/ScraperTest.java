...
public class ScraperTest {
    ...
    public static void main(String[] args) throws InterruptedException, IOException, KeyStoreException, NoSuchAlgorithmException, KeyManagementException, URISyntaxException {
        ...
        String downloadPath = "Z:\\mydownloads";

        FirefoxDriver driver = getFirefoxDriver(downloadPath);
        try {
            login(driver);
            FirefoxDriver downloadDriver = getFirefoxDriver("Z:\\RELEASENAME");
    ...
    @NotNull
    public static FirefoxDriver getFirefoxDriver(String downloadPath) {
    ...
    public static void cookie(FirefoxDriver driver) throws IOException {
        // InputStream inputStream = ScraperTest.class
        //         .getClassLoader()
        //         .getResourceAsStream("cookies.json");
        //
        // String theString = IOUtils.toString(inputStream);
        // // System.out.println(theString);
        // Type listType = new TypeToken<Set<Cookie>>() {
        // }.getType();
        // Set<Cookie> cookies = new Gson().fromJson(theString, listType);
        //
    ...
    public static void sslReq(String cookieForAPI) throws NoSuchAlgorithmException, KeyStoreException, KeyManagementException, IOException {
