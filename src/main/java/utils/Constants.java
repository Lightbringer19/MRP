...
public class Constants {
    ...
    public static final String scriptsDir = filesDir + "SCRIPTS\\";
    public static final String tagsDir = filesDir + "TAGS\\";
    public static final String collectorDir = filesDir + "COLLECT\\";
