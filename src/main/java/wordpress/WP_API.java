...
public class WP_API {
    ...
    static void Post(File jsonFile, MongoControl mongoControl) {
        InfoForPost info = Collector.Collect(jsonFile, mongoControl);
